...
public class CustomAdapterAnswerQuiz extends BaseAdapter implements ListAdapter {
    ...
    public CustomAdapterAnswerQuiz(ArrayList<String> list1, ArrayList<String> list2, ArrayList<Boolean> list3, Activity context) {
        this.list1 = list1;
        this.list2 = list2;
        this.list3 = list3;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_answerquiz, parent, false);
            // get all UI view
